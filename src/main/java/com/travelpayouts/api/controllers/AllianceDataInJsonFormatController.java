...
public class AllianceDataInJsonFormatController extends BaseStreamController<List<AllianceDataInJsonFormatModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static AllianceDataInJsonFormatController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the AllianceDataInJsonFormatController class 
     */
    public static AllianceDataInJsonFormatController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new AllianceDataInJsonFormatController();
            }
        }
        return instance;
    }
     ...
     */
    public void getAllianceDataInJsonFormatAsync(
                final APIStreamingCallBack<List<AllianceDataInJsonFormatModel>> callBack
    ) {
        ...
        _queryBuilder.append("/data/airlines_alliances.json ");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4925498278637692319L;
            {
