...
public class DataOnTheRoutesInJsonFormatController extends BaseStreamController<List<DataOnTheRoutesInJsonFormatModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static DataOnTheRoutesInJsonFormatController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the DataOnTheRoutesInJsonFormatController class 
     */
    public static DataOnTheRoutesInJsonFormatController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new DataOnTheRoutesInJsonFormatController();
            }
        }
        return instance;
    }
     ...
     */
    public void getDataOnTheRoutesInJsonFormatAsync(
                final APIStreamingCallBack<List<DataOnTheRoutesInJsonFormatModel>> callBack
    ) {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5166086491997569855L;
            {
