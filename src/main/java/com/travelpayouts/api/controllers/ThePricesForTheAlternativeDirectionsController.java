...
public class ThePricesForTheAlternativeDirectionsController extends BaseStreamController<List<ThePricesForTheAlternativeDirectionsModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static ThePricesForTheAlternativeDirectionsController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the ThePricesForTheAlternativeDirectionsController class 
     */
    public static ThePricesForTheAlternativeDirectionsController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new ThePricesForTheAlternativeDirectionsController();
            }
        }
        return instance;
    }
     ...
     * @param    GetThePricesForTheAlternativeDirectionsInput    Object containing request parameters
     * @param    queryParameters    Additional optional query parameters are supported by this endpoint
     * @return    Returns the void response from the API call 
     */
    public void getThePricesForTheAlternativeDirectionsAsync(
        ...
        _queryBuilder.append("/v2/prices/nearest-places-matrix");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5503445651993041308L;
            {
                    ...
                    put( "flexibility", input.getFlexibility() );
                    put( "distance", input.getDistance() );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5175031203928752557L;
            {
