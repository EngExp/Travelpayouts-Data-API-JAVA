...
public class CityDataInJsonFormatController extends BaseStreamController<List<CityDataInJsonFormatModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static CityDataInJsonFormatController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the CityDataInJsonFormatController class 
     */
    public static CityDataInJsonFormatController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new CityDataInJsonFormatController();
            }
        }
        return instance;
    }
     ...
     */
    public void getCityDataInJsonFormatAsync(
                final APIStreamingCallBack<List<CityDataInJsonFormatModel>> callBack
    ) {
        ...
        _queryBuilder.append("/data/cities.json");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4983584565391175120L;
            {
