...
public class TheCalendarOfPricesForAWeekController extends BaseStreamController<List<TheCalendarOfPricesForAWeekModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static TheCalendarOfPricesForAWeekController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the TheCalendarOfPricesForAWeekController class 
     */
    public static TheCalendarOfPricesForAWeekController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new TheCalendarOfPricesForAWeekController();
            }
        }
        return instance;
    }
     ...
     * @param    GetTheCalendarOfPricesForAWeekInput    Object containing request parameters
     * @param    queryParameters    Additional optional query parameters are supported by this endpoint
     * @return    Returns the void response from the API call 
     */
    public void getTheCalendarOfPricesForAWeekAsync(
        ...
        _queryBuilder.append("/v2/prices/week-matrix");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5242464142614102604L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4658640835256130424L;
            {
