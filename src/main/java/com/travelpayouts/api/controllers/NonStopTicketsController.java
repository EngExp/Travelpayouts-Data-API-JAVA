...
public class NonStopTicketsController extends BaseStreamController<List<NonStopTicketsModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static NonStopTicketsController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the NonStopTicketsController class 
     */
    public static NonStopTicketsController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new NonStopTicketsController();
            }
        }
        return instance;
    }
     ...
     * @param    GetNonStopTicketsInput    Object containing request parameters
     * @param    queryParameters    Additional optional query parameters are supported by this endpoint
     * @return    Returns the void response from the API call 
     */
    public void getNonStopTicketsAsync(
        ...
        _queryBuilder.append("/v1/prices/direct");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5061000550016057482L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5277004572065955608L;
            {
