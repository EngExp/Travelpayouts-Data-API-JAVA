...
public class PopularAirlineRoutesController extends BaseStreamController<List<PopularAirlineRoutesModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static PopularAirlineRoutesController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the PopularAirlineRoutesController class 
     */
    public static PopularAirlineRoutesController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new PopularAirlineRoutesController();
            }
        }
        return instance;
    }
     ...
     * @param    GetPopularAirlineRoutesInput    Object containing request parameters
     * @param    queryParameters    Additional optional query parameters are supported by this endpoint
     * @return    Returns the void response from the API call 
     */
    public void getPopularAirlineRoutesAsync(
                final GetPopularAirlineRoutesInput input,
                Map<String, Object> queryParameters,
                final APIStreamingCallBack<List<PopularAirlineRoutesModel>> callBack
    ) {
        //validating required parameters
        if (null == input.getAirlineCode())
            throw new NullPointerException("The property \"AirlineCode\" in the input object cannot be null.");
        ...
        _queryBuilder.append("/v1/airline-directions");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5082183966341907473L;
            {
                    put( "airline_code", input.getAirlineCode() );
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5424987692485072342L;
            {
