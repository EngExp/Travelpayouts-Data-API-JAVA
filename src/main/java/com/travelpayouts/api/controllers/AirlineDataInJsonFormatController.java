...
public class AirlineDataInJsonFormatController extends BaseStreamController<List<AirlineDataInJsonFormatModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static AirlineDataInJsonFormatController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the AirlineDataInJsonFormatController class 
     */
    public static AirlineDataInJsonFormatController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new AirlineDataInJsonFormatController();
            }
        }
        return instance;
    }
     ...
     */
    public void getAirlineDataInJsonFormatAsync(
                final APIStreamingCallBack<List<AirlineDataInJsonFormatModel>> callBack
    ) {
        ...
        _queryBuilder.append("/data/airlines.json ");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5426515213176349355L;
            {
