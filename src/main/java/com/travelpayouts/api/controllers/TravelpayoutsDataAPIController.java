...
public class TravelpayoutsDataAPIController extends BaseController {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static TravelpayoutsDataAPIController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the TravelpayoutsDataAPIController class 
     */
    public static TravelpayoutsDataAPIController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new TravelpayoutsDataAPIController();
            }
        }
        return instance;
    }
    ...
    public String getSpecialOffers(
        ...
        getSpecialOffersAsync(callback);
     ...
     */
    public void getSpecialOffersAsync(
        ...
        _queryBuilder.append("/v2/prices/special-offers");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4808924257824807959L;
            {
