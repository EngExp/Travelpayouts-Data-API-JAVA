...
public class DataOfCountriesInJsonFormatController extends BaseStreamController<List<DataOfCountriesInJsonFormatModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static DataOfCountriesInJsonFormatController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the DataOfCountriesInJsonFormatController class 
     */
    public static DataOfCountriesInJsonFormatController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new DataOfCountriesInJsonFormatController();
            }
        }
        return instance;
    }
     ...
     */
    public void getDataOfCountriesInJsonFormatAsync(
                final APIStreamingCallBack<List<DataOfCountriesInJsonFormatModel>> callBack
    ) {
        ...
        _queryBuilder.append("/data/countries.json");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4635338505074314195L;
            {
