...
public class AirportDataInJsonFormatController extends BaseStreamController<List<AirportDataInJsonFormatModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static AirportDataInJsonFormatController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the AirportDataInJsonFormatController class 
     */
    public static AirportDataInJsonFormatController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new AirportDataInJsonFormatController();
            }
        }
        return instance;
    }
     ...
     */
    public void getAirportDataInJsonFormatAsync(
                final APIStreamingCallBack<List<AirportDataInJsonFormatModel>> callBack
    ) {
        ...
        _queryBuilder.append("/data/airports.json");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4728152844345400544L;
            {
