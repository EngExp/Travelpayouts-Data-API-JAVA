...
public class TheCalendarOfPricesForAMonthController extends BaseStreamController<List<TheCalendarOfPricesForAMonthModel>> {    
    //private static variables for the singleton pattern
    private static Object syncObject = new Object();
    private static TheCalendarOfPricesForAMonthController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the TheCalendarOfPricesForAMonthController class 
     */
    public static TheCalendarOfPricesForAMonthController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new TheCalendarOfPricesForAMonthController();
            }
        }
        return instance;
    }
     ...
     * @param    GetTheCalendarOfPricesForAMonthInput    Object containing request parameters
     * @param    queryParameters    Additional optional query parameters are supported by this endpoint
     * @return    Returns the void response from the API call 
     */
    public void getTheCalendarOfPricesForAMonthAsync(
        ...
        if (null == input.getMonth())
            throw new NullPointerException("The property \"Month\" in the input object cannot be null.");
        ...
        _queryBuilder.append("/v2/prices/month-matrix");

        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4753878418799210515L;
            {
                    put( "currency", input.getCurrency() );
                    put( "origin", input.getOrigin() );
                    put( "destination", input.getDestination() );
                    put( "month", input.getMonth() );
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5122418846348143858L;
            {
